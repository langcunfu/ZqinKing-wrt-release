...
install_custom_feed() {
    ...
    local base_custom_feed_packages=(
        ...
        msd_lite luci-app-msd_lite cups luci-app-cupsd linkease linkease-common-bin luci-app-linkease luci-lib-linkeasefile
    )
    local required_feed_dirs=(
        ...
        luci-app-emmc-health linkease linkease-common-bin luci-app-linkease luci-lib-linkeasefile
    )
